...
public class PaymentServiceTest {
    ...
    void 결제_생성_성공_테스트() {
        ...
        ReflectionTestUtils.setField(request, "amount", BigDecimal.valueOf(8000));
        ReflectionTestUtils.setField(request, "payType", PayType.POINT);
        ...
        assertEquals(BigDecimal.valueOf(8000), response.getAmount());
        assertEquals(PayType.POINT, response.getPayType());
    ...
    void 결제_생성_실패_테스트() {
        ...
        // when & then
        assertThrows(UserException.class, () -> paymentService.createPayment(request));
